...
export function renderProfileScreen(root) {
  ...
  <section class="astro-screen astro-two-column">
      ...
      <header class="astro-screen-header">
        <div>
          ...
          <p style="font-size: 0.82rem; color: rgba(190,200,255,0.8);">
            Update your display name for your Astro AI account. This version of AstroAI doesn’t 
    ...
    <div class="astro-card astro-profile-card-right">
      <div class="astro-profile-aside-inner">
        <img
          src="assets/img/astroailogo.png"
          alt="Astro AI logo"
          class="astro-profile-logo"
        />
        <p class="astro-profile-aside-text">
